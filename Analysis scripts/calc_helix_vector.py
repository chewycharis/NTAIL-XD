...
helix_inds = [0,0,0,0];
helix_inds[0] = traj.topology.select('residue 2 to 11'); # 13 to 18 for holo, 6 to 18 for apo
helix_inds[1] = traj.topology.select('residue 16 to 28');
helix_inds[2] = traj.topology.select('residue 33 to 49');
helix_inds[3] = traj.topology.select('residue 54 to 72');
